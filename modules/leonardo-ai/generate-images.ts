...
export default async function generateImages(title:string,image_description:string) {
    ...
    try {
       ...
       return getImageJsonResponse.generations_by_pk.generated_images.map((image:any) => {
        return image.id
       })
